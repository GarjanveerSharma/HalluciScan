...
const steps = [
  { num: '01', title: 'Install Extension', desc: 'Download and add Ghost to your Chrome browser.', icon: '⬇️' },
  ...
  { num: '04', title: 'AI Analysis', desc: 'Response is sent to Ghost analyzer for verification.', icon: '🧠' },
