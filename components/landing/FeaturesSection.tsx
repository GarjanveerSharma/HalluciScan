...
const features = [
  ...
  },
  {
    ...
    desc: 'Powered by an advanced LLM that strictly verifies subject-relation-object accuracy instead of just matching keywords.',
  },
  {
    icon: '⚡',
    title: 'Keyless Intelligent Fallback',
    desc: 'Seamlessly works out of the box using a free text generation endpoint even if you do not provide your own API keys.',
  },
  {
    icon: '🖍️',
